...
static const char *const yytname[] =
{
  ...
  "$accept", "declaration_list", "declaration", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 96 "src/porygon_syntax.y"
                                        {printf("Found declaration.\n");}
#line 1280 "src/parser.c"
    break;

  case 3:
#line 97 "src/porygon_syntax.y"
                                        {printf("Found recursive declaration.\n");}
#line 1286 "src/parser.c"
    break;

  case 4:
#line 101 "src/porygon_syntax.y"
                                        {printf("Found SUM OPERATION.\n");}
